...
public class DBTest {
    ...
    public void testDataFromDB() throws SQLException, ClassNotFoundException {
        ...
        final String LOGIN = "G6_pustovoit";
...
//        log.info(dataFromSeleniumTable.get(1).get("login"));
        ...
        int numberOfRows = mysqlDB.changeTable("INSERT INTO seleniumTable VALUES(135, '%s', 654321 )", LOGIN);
        log.info("Numer of inserted rows = " + numberOfRows);
        ...
        int deletedRows =
                mysqlDB.changeTable("DELETE from seleniumTable WHERE login = '%s'", LOGIN);
