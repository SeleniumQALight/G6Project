...
public class ApiHelper {
    public static final String USER_NAME = "qamargo";
    ...
    public void deletePostsTillPresent(String userName, String password) {
        ...
        for (int i = 0; i < listOfPosts.length; i++) {
            ...
            logger.info(String.format("Post with id %s and title %s was deleted", listOfPosts[1].getId(), listOfPosts[i].getTitle()));
