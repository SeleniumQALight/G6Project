...
public class EditPostTest extends BaseTest {
    final String POST_TITLE = "TC3_komenda_" + Util.getDateAndTimeFormatted();
    final String POST_BODY = "Test text in body";
    final String NEW_POST_TITLE = "TC3_komenda_updated_title";
    ...
    public void CreatePost(){
        homePage
                ...
                .checkIsTitleDisplayed(POST_TITLE)
                .checkIsNoteDisplayed("Note: This post was written for")
    ...
    public void TC3_EditPostTest (){
        homePage
                ...
                .checkIsRedirectToMyProfilePage()
                .checkIsPostPresentAndUnique(NEW_POST_TITLE);
    }
    @After
