Feature: User registrationForm
  ...
  Scenario Outline: R003 Warning <messages>
    ...
    Examples:
      ...
      | tr       | ttt        | ttt          | Username must be at least 3 characters.,You must provide a valid email address.,Password must be at least 12 characters. |
      | Test     | test@g.net | test         | Password must be at least 12 characters.                                                                                 |
      | test     | mail.com   | 123456qwerty | This username is already taken.,You must provide a valid email address.                                                  |